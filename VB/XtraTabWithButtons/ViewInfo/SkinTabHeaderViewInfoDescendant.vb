...
Namespace XtraTabWithButtons
    ...
    Public Class SkinTabHeaderViewInfoDescendant
        ...
        Private Function CalcSize(ByVal info As BaseTabPageViewInfo, ByVal PageSize As Size) As Size
            ...
            If Not ButtonsSize.IsEmpty Then rect = New Rectangle(pageBounds.X + pageBounds.Width - ButtonsSize.Width, pageBounds.Y + pageBounds.Height - ButtonsSize.Height, ButtonsSize.Width, ButtonsSize.Height)
        ...
        Protected Overrides Sub UpdatePageBounds(ByVal info As BaseTabPageViewInfo)
            ...
            If HeaderLocation = TabHeaderLocation.Right AndAlso RealPageOrientation = TabOrientation.Horizontal Then infodes.PagePanel.Bounds = New Rectangle(New Point(infodes.PagePanel.Bounds.X + hIndent, infodes.PagePanel.Bounds.Y), infodes.PagePanel.Bounds.Size)
            If HeaderLocation = TabHeaderLocation.Left AndAlso RealPageOrientation = TabOrientation.Horizontal Then infodes.PagePanel.Bounds = New Rectangle(New Point(infodes.PagePanel.Bounds.X - hIndent, infodes.PagePanel.Bounds.Y), infodes.PagePanel.Bounds.Size)
            If HeaderLocation = TabHeaderLocation.Right AndAlso (RealPageOrientation = TabOrientation.Default OrElse RealPageOrientation = TabOrientation.Vertical) Then infodes.PagePanel.Bounds = New Rectangle(New Point(infodes.PagePanel.Bounds.X + hIndent, infodes.PagePanel.Bounds.Y), infodes.PagePanel.Bounds.Size)
            If HeaderLocation = TabHeaderLocation.Left AndAlso (RealPageOrientation = TabOrientation.Default OrElse RealPageOrientation = TabOrientation.Vertical) Then infodes.PagePanel.Bounds = New Rectangle(New Point(infodes.PagePanel.Bounds.X - hIndent, infodes.PagePanel.Bounds.Y), infodes.PagePanel.Bounds.Size)
            If HeaderLocation = TabHeaderLocation.Top AndAlso RealPageOrientation = TabOrientation.Vertical Then infodes.PagePanel.Bounds = New Rectangle(New Point(infodes.PagePanel.Bounds.X, infodes.PagePanel.Bounds.Y - hIndent), infodes.PagePanel.Bounds.Size)
            If HeaderLocation = TabHeaderLocation.Bottom AndAlso RealPageOrientation = TabOrientation.Vertical Then infodes.PagePanel.Bounds = New Rectangle(New Point(infodes.PagePanel.Bounds.X, infodes.PagePanel.Bounds.Y + hIndent), infodes.PagePanel.Bounds.Size)
            Dim g As Graphics = GraphicsInfo.Graphics
        ...
        Protected Overrides Function GetToolTipInfo(ByVal point As Point) As ToolTipControlInfo
            ...
            If hit.Page IsNot Nothing AndAlso Not hit.InPageControlBox Then
